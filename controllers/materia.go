...
import (
	...
	"github.com/jorgec815/test_api_crud/models"
...
// URLMapping ...
func (c *MateriaController) URLMapping() {
...
// @Param	body		body 	models.Materia	true		"body for Materia content"
// @Success 201 {int} models.Materia
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *MateriaController) Post() {
	var v models.Materia
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddMateria(&v); err == nil {
...
// @router /:id [get]
func (c *MateriaController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetMateriaById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 404 not found resource
// @router / [get]
func (c *MateriaController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllMateria(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
// @Failure 400 the request contains incorrect syntax
// @router /:id [put]
func (c *MateriaController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Materia{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateMateriaById(&v); err == nil {
...
// @Failure 404 not found resource
// @router /:id [delete]
func (c *MateriaController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteMateria(id); err == nil {
